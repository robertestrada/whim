    ...
    <div className={ showProfileDrop ? "profile-dropdown__container" : "profile-dropdown__container profile-dropdown-hide"}>
      ...
      <div className="profile-dropdown__profile-link-container">
        ...
        <div className="profile-dropdown__profile-info-container">
          <div className="profile-dropdown__profile-name">{`${user.first_name} ${user.last_name}`}</div>
          View Profile
        </div>
        <svg viewBox="0 0 6 10" className="profile-dropdown__profile-right-arrow">
      ...
      <div className="profile-dropdown__wishlist-wrapper">
        <svg viewBox="0 0 21 19" className="profile-dropdown__wishlist-svg">
      ...
      <div className="profile-dropdown__cart-wrapper" onClick={handleCartClick}>
        <svg viewBox="0 0 21 17" xmlns="http://www.w3.org/2000/svg" className="profile-dropdown__cart-svg">
          <g fill="none" fillRule="evenodd">
      ...
      <div className="profile-dropdown__order-history-wrapper">
        <svg viewBox="0 0 14 16" className="profile-dropdown__order-history-svg">
          <g fill="none" fillRule="evenodd">
      ...
      <div className="profile-dropdown__section-break"/>
      <div className="profile-dropdown__hire-wrapper">
        Hire the Developer
      </div>
      <div className="profile-dropdown__logout-wrapper" onClick={handleSubmit}>
        Logout
      </div>
    </div>
  );
