...
const SideCart = ({ cartItems, imageLoaded, setImageLoaded }) => {

  return (
    <>
      <div className="sidecart__view-button-top">View Cart</div>
      ...
      <div className="sidecart__view-button-bottom">View Cart</div>
    </>
  );
}
