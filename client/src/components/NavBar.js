...
const NavBar = ({ setPageData, setViewSwitch, setAllowSearch, searchTerm, setSearchTerm, panelType, setPanelType, lastSearchTerm, setLastSearchTerm }) => {
  ...
  return (
    <div className="navbar">
      ...
      <div className={panelType === 'feed' ? "navbar__options" : "navbar__options navbar-hidden"}>
        <Search setPageData={setPageData} setViewSwitch={setViewSwitch} setAllowSearch={setAllowSearch} searchTerm={searchTerm} setSearchTerm={setSearchTerm} lastSearchTerm={lastSearchTerm} setLastSearchTerm={setLastSearchTerm}/>
