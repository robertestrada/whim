...
with app.app_context():
  ...
  o_list = [
      ...
      Option(size="xs", color="", price_starting=20.00, price_ending=20.00, inventory_starting=20000, inventory_ending=10000, weight=2.00, product_id=1),
      Option(size="s", color="", price_starting=20.00, price_ending=20.00, inventory_starting=5000, inventory_ending=2000, weight=2.00, product_id=1),
      ...
      Option(size="l", color="", price_starting=20.00, price_ending=20.00, inventory_starting=2000, inventory_ending=1000, weight=2.00, product_id=1),
      ...
      Option(size="xl", color="", price_starting=20.00, price_ending=20.00, inventory_starting=1000, inventory_ending=500, weight=2.00, product_id=1),
